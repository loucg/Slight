...
/** 
 * 类名称：StrategyTRMLController
 * 创建人：zjc
 * 更新时间：2017年2月18日
 * @version
 */
@Controller
@RequestMapping(value="/strategyTRML")
public class StrategyTRMLController extends BaseController{
	 ...
	 * @return
	 */
	@RequestMapping("/listTRMLs")
	public ModelAndView listTRMLs(Page page) throws Exception{
