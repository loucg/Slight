		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="pole/${msg}.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input style="width:95%;" type="text" name="vendor" id="vendor" value="${pd.vendor}" maxlength="500" title="<%=vendor%>"/></td>
							</tr>
							<tr>
