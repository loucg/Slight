							...
							<tr>
								...
								<td>
									<div class="nav-search">
									    <label>功能键：</label>
										<input class="nav-search-input" autocomplete="off" id="functionkey" type="text" name="functionkey" value="${pd.functionkey}" placeholder="这里输入功能键" />
									</div>
								</td>
								<td >
								 	<div class="nav-search">
									    <label style="margin-left:12px;">功能分类：</label>
										<input class="nav-search-input" autocomplete="off" id="functiontype" type="text" name="functiontype" value="${pd.functiontype }" placeholder="这里输入功能分类" />
									</div>
								</td>
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
							<thead>
								<tr>
									...
									<th class="center" >功能键</th>
									<th class="center" >功能值</th>
									<th class="center" >功能分类</th>
									<th class="center" >功能简述</th>
