					...
					<div class="row">
						...
						<table style="margin-top:5px;">
							<tr>
								...
								<div class="nav-search" style="padding-left:12px;">
								<label>截止时间：</label>
								<input class="span10 date-picker" name="endtime" name="endtime"  value="${pd.endtime}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:100px;height:28px" placeholder="截止日期" title="截止日期"/>
								</div>
								</td>
