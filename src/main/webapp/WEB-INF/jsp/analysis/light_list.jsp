			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="lightanalysis/list" method="post" name="Form" id="Form">
						...
						<table style="margin-top:5px;">
							<tr>
								...
								<label>开始时间：</label>
								<input class="span10 date-picker" name="starttime" id="starttime"  value="${pd.starttime}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:100px; height:28px" placeholder="开始日期" title="开始日期"/>
								</div>
								</td>
								<td>
								<div class="nav-search" style="padding-left:12px">
								<label>结束时间：</label>
								<input class="span10 date-picker" name="endtime" name="endtime"  value="${pd.endtime}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:100px; height:28px" placeholder="结束日期" title="结束日期"/>
								</div>
								</td>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class="center">${var.per}</td>
											<td class="center">${var.time}</td>
											<td class="center">${var.day}</td>
