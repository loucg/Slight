			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="strategyGroup/listOthers.do?id=${strategyforpage.id }" method="post" name="Form" id="Form">
						...
						<table class="table table-striped table-bordered table-hover" style="margin-top:5px;">
							<tr>
								<th class='center'>“${strategyforpage.name }策略” 新增应用选择</th>
							</tr>
						</table>
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:1px;">	
							...
							<c:choose>
								...
								<c:otherwise>
									<tr class="main_info">
										<td colspan="100" class="center" >应用组已分配完毕</td>
									</tr>
								</c:otherwise>
							</c:choose>
							</tbody>
				...
				if(result) {
					...
					if(str==''){
						...
						if(msg == '确定要新增选中的应用组吗?'){
							...
							$.ajax({
								type: "POST",
								url: '<%=basePath%>strategyGroup/addGroups.do?id='+id,
						    	data: {DATA_IDS:str},
								dataType:'json',
								cache: false,
