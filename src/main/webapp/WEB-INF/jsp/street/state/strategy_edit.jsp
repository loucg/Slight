		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="state/lamp/${msg }.do?DATA_IDS=${pd.DATA_IDS}" name="strategyForm" id="strategyForm" method="post">
...
<!-- /.main-container -->
	...
	<script type="text/javascript">
		...
		$(function() {
			$.ajax({
				type: "POST",
				url: '<%=basePath%>state/lamp/getLevels.do?tm='+new Date().getTime(),
		    	data: {},
				dataType:'json',
				cache: false,
